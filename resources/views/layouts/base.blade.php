                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a href="#contact-us" class="menu-item">Contact
                                        Us</a>
                                </li>
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->utype === 'ADM')
                                            ...
                                            <li class="submenu">
                                                <a href="#">Menu</a>
                                                <ul>
                                                    <li><a href="" class="menu-item">{{ Auth::user()->name }}</a>
                                                    </li>
                                        ...
                                        @else
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="" class="menu-item">Saldo
                                                            {{ Auth::user()->usd }}</a>
                                                    </li>
