            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>Desarrollo <em>creativo</em></h1>
                        <p>PYDO <a href="#">Aplicaciones</a> simples de organización <a href="#">Temporal</a>.
                            Para clientes de organisacion de Template totalmente responsive y adaptado para miviles y
                            table
                            .</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>02</h2>
                            <img src="https://i.postimg.cc/fT6mw1tw/Icon-design-pana.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>03</h2>
                            <img src="https://i.postimg.cc/1z48wHNW/Connected-world-bro.png" alt="">
                            <h4>Email Design</h4>
                            <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                            <a href="#testimonials" class="main-button">
                                More Detail
        ...
        <div class="container">
            <div class="row">
                <div class="left-image col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="https://i.postimg.cc/ZKMS4QtK/left-image.png" class="rounded img-fluid d-block mx-auto"
                        alt="App">
                </div>
                <div class="right-text offset-lg-1 col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                    <ul>
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            <img src="https://i.postimg.cc/MpgqbFdr/about-icon-02.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.6s">
                            <img src="https://i.postimg.cc/Kz2bCgXP/about-icon-03.png" alt="">
                            <div class="text">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="https://i.postimg.cc/FFY0RNDN/artificial.jpg" alt="Author One"></i>
                            </div>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="https://i.postimg.cc/Pf0Yv9RZ/artificial2.jpg" alt="Second Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="https://i.postimg.cc/Tw2DjXV2/artificial3.jpg" alt="Author Third"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="https://i.postimg.cc/jj4fJjJk/artificial4.jpg" alt="Fourth Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
