            ...
            <div class="row">
                <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                    ...
                    <p>PYDO <a href="#">Aplicaciones</a> simples de organización <a href="#">Temporal</a>.
                        Para clientes de organisacion de Template totalmente responsive y adaptado para miviles y table
                        .</p>
            ...
            <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="https://i.postimg.cc/vT8sZFZD/testimonial-author-1.png" alt="Author One"></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="https://i.postimg.cc/vT8sZFZD/testimonial-author-1.png"
                                    alt="Second Author"></i>
                        </div>
                        <div class="testimonial-content">
                            <ul class="stars">
                    ...
                    <div class="item service-item">
                        <div class="author">
                            <i><img src="https://i.postimg.cc/vT8sZFZD/testimonial-author-1.png" alt="Author Third"></i>
                        </div>
                        <div class="testimonial-content">
                            <ul class="stars">
                                <li><i class="fa fa-star"></i></li>
